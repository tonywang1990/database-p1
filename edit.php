...
<div class="w3-third">
<p><label class="w3-label"><strong>ID:</strong></label>   <?php echo $id; ?></p>
...
<input type="text" name="scholar" value="<?php echo $scholar; ?>"/>
</p>

<p>
<label class="w3-label">Education:</label>
<input type="text" name="edu" value="<?php echo $edu; ?>"/>
</p>
